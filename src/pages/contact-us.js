...
const ContactUs = () => (
  <Layout>
    <Helmet
      title="Contact Us - InFact Digital Co-op"
      meta={[
        {
          name: 'description',
          content:
            'If you have a project idea you would like to collaborate on, want to ask some questions or just connect and say hi, drop us a line!',
        },
      ]}
    />
